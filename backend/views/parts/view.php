...
<div class="giiant-crud parts-view">
    ...
    <?php $this->beginBlock('app\models\Parts'); ?>
...
<?php $this->endBlock() ?>
    ...
    'content' => $this->blocks['app\models\Parts'],
    'active'  => true,
],[
    'content' => $this->blocks['Questions'],
    'label'   => '<small>Questions <span class="badge badge-default">'.count($model->getQuestions()->asArray()->all()).'</span></small>',
    'active'  => false,
], ]
                 ]
    );
